  ...
  useEffect(() => {
    const handleScroll = () => {
      if (sectionRef.current) {
        ...
        // Calculate offset only when section is near/in viewport for performance
        if (rect.top < window.innerHeight && rect.bottom > 0) {
          setOffset(window.scrollY * 0.15); // Adjust speed factor here
        }
      }
    };
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center fade-in-blur">
        ...
        <h2 className="font-display text-4xl lg:text-6xl font-bold mb-8 leading-tight">
          La <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400">Trampa Digital</span>
        </h2>
        ...
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 lg:p-12 rounded-3xl relative overflow-hidden group hover:border-pathos-cyan/30 transition-colors duration-500">
            ...
            <p className="text-xl lg:text-2xl text-blue-100 leading-relaxed font-light">
              Es tener una web bonita que <strong className="text-white font-semibold">no vende</strong>, o tener muchas ventas que <strong className="text-white font-semibold">te quitan la vida</strong>.
            </p>
            
            <div className="mt-8 pt-8 border-t border-white/10">
                <p className="text-slate-400 text-lg">
                    Necesitas equilibrio: Una marca magnética hacia fuera y un reloj suizo por dentro.
                </p>
            </div>
        </div>
