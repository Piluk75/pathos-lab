      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div className="max-w-2xl fade-in-section">
          ...
          <h1 className="font-display text-4xl lg:text-7xl font-bold leading-[1.1] mb-8">
            Diseño Web <span className="text-gradient-light">IA</span> que conecta.<br />
            Automatización que <span className="text-gradient-light">escala</span>.
          </h1>
          
          <p className="text-lg lg:text-xl text-slate-300 mb-10 leading-relaxed max-w-lg">
            En Pathos Lab creamos la arquitectura digital que tu negocio necesita para dominar Google y ser recomendado por ChatGPT. Diseño web de alta gama y sistemas inteligentes para liberar tu tiempo.
          </p>
          ...
          <div className="mt-12 pt-8 border-t border-white/10 flex items-center gap-6">
            <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-400 uppercase tracking-wider">Compromiso</span>
            </div>
            <div className="w-px h-8 bg-white/20"></div>
            <div className="flex flex-col">
                <span className="text-2xl font-bold font-display text-white">24/7</span>
                <span className="text-xs text-slate-400 uppercase tracking-wider">Operatividad</span>
            </div>
          </div>
        </div>
